...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (!message.member.hasPermission('ADMINISTRATOR') || ('BAN_MEMBERS')) return;
        ...
        if(user.hasPermission('ADMINISTRATOR') || ('BAN_MEMBERS')) return (message.channel.send(permerror)).then(message.delete())
